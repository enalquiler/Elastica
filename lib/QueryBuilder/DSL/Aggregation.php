...
use Enalquiler\Elastica\Aggregation\DateRange;
use Enalquiler\Elastica\Aggregation\ExtendedStats;
use Enalquiler\Elastica\Aggregation\Filter as FilterAggregation;
use Enalquiler\Elastica\Aggregation\Filters;
use Enalquiler\Elastica\Aggregation\GeoDistance;
use Enalquiler\Elastica\Aggregation\GeohashGrid;
use Enalquiler\Elastica\Aggregation\GlobalAggregation;
use Enalquiler\Elastica\Aggregation\Histogram;
use Enalquiler\Elastica\Aggregation\IpRange;
use Enalquiler\Elastica\Aggregation\Max;
use Enalquiler\Elastica\Aggregation\Min;
use Enalquiler\Elastica\Aggregation\Missing;
use Enalquiler\Elastica\Aggregation\Nested;
use Enalquiler\Elastica\Aggregation\Percentiles;
use Enalquiler\Elastica\Aggregation\Range;
use Enalquiler\Elastica\Aggregation\ReverseNested;
...
use Enalquiler\Elastica\Aggregation\Stats;
use Enalquiler\Elastica\Aggregation\Sum;
use Enalquiler\Elastica\Aggregation\Terms;
use Enalquiler\Elastica\Aggregation\TopHits;
