...
class ScriptTest extends BaseTest
{
    ...
    public function testCreateString()
    {
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\Script\Script', $script);
    ...
    public function testSetLang()
    {
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\Script\Script', $script->setLang(Script::LANG_PYTHON));
    }
    ...
    public function testSetScript()
    {
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\Script\Script', $script->setScript('foo'));
    }
}
