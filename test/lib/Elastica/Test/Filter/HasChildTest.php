...
class HasChildTest extends BaseTest
{
    ...
    public function testSetType()
    {
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\Filter\HasChild', $returnValue);
    }
    ...
    {
        $f = new \Enalquiler\Elastica\Filter\MatchAll();
    ...
    public function testFilterInsideHasChildSearch()
    {
        ...
        $f = new \Enalquiler\Elastica\Filter\Term();
        $f->setTerm('user', 'child1');
        $filter = new HasChild($f, 'child');

        $searchQuery = new \Enalquiler\Elastica\Query();
    ...
    public function testQueryInsideHasChildSearch()
    {
        ...
        $f = new \Enalquiler\Elastica\Query\Term();
        $f->setTerm('user', 'child1');
        $filter = new HasChild($f, 'child');
    ...
    public function testTypeInsideHasChildSearch()
    {
        ...
        $f = new \Enalquiler\Elastica\Query\Match();
    ...
    private function prepareSearchData()
    {
        ...
        $childMapping = new \Enalquiler\Elastica\Type\Mapping($childType);
