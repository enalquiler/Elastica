<?php
namespace Enalquiler\Elastica\Test\Bulk;
...
class ResponseSetTest extends BaseTest
{
    ...
    public function testGetError()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Enalquiler\Elastica\\Bulk\\ResponseSet', $responseSet);
            ...
            $this->assertInstanceOf('Enalquiler\Elastica\Exception\Bulk\Response\ActionException', $actionExceptions[0]);
            ...
            $this->assertInstanceOf('Enalquiler\Elastica\Exception\Bulk\Response\ActionException', $actionExceptions[1]);
    ...
    public function testIterator()
    {
        ...
        $this->assertNotInstanceOf('Enalquiler\Elastica\Bulk\Response', $responseSet->current());
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\Bulk\Response', $responseSet->current());
    }
    ...
    {
        $client = $this->getMock('Enalquiler\\Elastica\\Client', ['request']);
