...
use Enalquiler\Elastica\Multi\Search as MultiSearch;
...
class SearchTest extends BaseTest
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\Multi\Search', $multiSearch);
    ...
    public function testSearch()
    {
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\Multi\ResultSet', $multiResultSet);
        $this->assertCount(2, $multiResultSet);
        $this->assertInstanceOf('Enalquiler\Elastica\Response', $multiResultSet->getResponse());
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\ResultSet', $resultSets[0]);
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\ResultSet', $resultSets[1]);
    ...
    public function testSearchWithKeys()
    {
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\ResultSet', $multiResultSet['search1']);
        $this->assertInstanceOf('Enalquiler\Elastica\ResultSet', $multiResultSet['search2']);
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\ResultSet', $resultSets['search1']);
        ...
        $this->assertInstanceOf('Enalquiler\Elastica\ResultSet', $resultSets['search2']);
